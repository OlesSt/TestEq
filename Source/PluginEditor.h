...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<TestEqAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<TestEqAudioProcessor::BlockType>* leftChannelFifo;
...
private:
    ...
    juce::Rectangle<int> getAnalysisAre();
